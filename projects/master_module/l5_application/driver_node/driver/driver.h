...
#define OBSTACLE_VERY_NEAR 6U // 55U
#define OBSTACLE_NEAR 12U     // 65U //
#define OBSTACLE_MID 30U      // 100U //
#define OBSTACLE_FAR 60U      // 160U //

#define MOTOR_VERY_SLOW_KPH 5.30
#define MOTOR_SLOW_KPH 5.40
#define MOTOR_MED_KPH 5.50
#define MOTOR_FAST_KPH 5.60
#define MOTOR_STOP_KPH 5.00
//#define MOTOR_REV_SLOW_KPH 0.40
#define MOTOR_REV_MED_KPH 4.00 //-0.50
